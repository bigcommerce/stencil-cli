...
const fileUrl = new URL('../schemas/schemaTranslations.json', import.meta.url);
const schemaTranslations = JSON.parse(readFileSync(fileUrl));
...
export default ValidatorSchemaTranslations;
