...
internals.parseAnswers = function(JspmAssembler, ThemeConfig, StorefrontConfig, dotStencilFile, dotStencilFilePath, answers) {
    ...
    StorefrontConfig.getInstance().init();
};

internals.implementation = function(JspmAssembler, ThemeConfig, StorefrontConfig, dotStencilFilePath, url, token, port) {
    var dotStencilFile;
    var questions;
    ...
    Inquirer.prompt(questions, function(answers) {
        internals.parseAnswers(JspmAssembler, ThemeConfig, StorefrontConfig, dotStencilFile, dotStencilFilePath, answers);
    });
};
