...
class StencilStart {
    ...
    async run(cliOptions) {
        ...
        if (!cliOptions.channelId) {
            // eslint-disable-next-line no-param-reassign
            cliOptions.channelId = await this.getChannelId(updatedStencilConfig, cliOptions);
        }
    ...
    async getChannelId(stencilConfig, cliOptions) {
        ...
        const channelId = await this._stencilPushUtils.promprtUserToSelectChannel(channels);
        return channelId;
    }
