...
class StencilStart {
    ...
    async run(cliOptions) {
        ...
        const channelUrl = await this.getChannelUrl(updatedStencilConfig, cliOptions);

        await this.startLocalServer(cliOptions, updatedStencilConfig, channelUrl);
     ...
     * @return {Promise<any>}
     */
    async startLocalServer(cliOptions, stencilConfig, channelUrl) {
